  ...
  <div className="flex flex-col items-center">
    ...
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="relative">
        <h1 className="rounded bg-black px-2.5 py-1.5 text-center text-2xl text-white sm:text-5xl">
          Kristian Gerardsson
        </h1>
      ...
      <h2 className="mt-2 rounded bg-[#cc0178] px-2.5 py-0.5 text-center text-xl text-white sm:text-3xl">
