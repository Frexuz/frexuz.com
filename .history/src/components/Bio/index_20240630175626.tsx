...
export const Bio = ({ isMobile }: { isMobile: boolean }) => (
  <div className="flex flex-col items-center">
    ...
    <div
      className={`mb-12 p-1.5 rounded-full ${
        isMobile ? 'w-[150px] h-[150px]' : 'w-[250px] h-[250px]'
      }`}
      style={{
    ...
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="relative">
        <h1 className="rounded bg-black px-2.5 py-1.5 text-center text-5xl text-white">
          Kristian Gerardsson
        </h1>
        <h4 className="absolute right-0.5 top-[-1rem] rounded px-2.5 py-1.5 text-sm font-bold">
          AKA FREXUZ
        </h4>
      </div>
      <h2
