  ...
  return (
    <div className="flex items-center">
      <div className="flex flex-1 flex-col items-center justify-center">
        <div className="text-18 mt-5 flex flex-wrap items-center justify-center text-center font-bold leading-7">
        ...
        <h2 className="mt-12 rounded bg-black px-2 py-1 text-center text-xl text-white sm:text-2xl">
          I&apos;m a coder
        </h2>
        <h3 className="text-18 mt-5 text-center font-bold leading-7">
        ...
        <span role="img" aria-label="Cats" className="text-32 mb-10 mt-5 block">
          😻😻
        </span>
        <a
