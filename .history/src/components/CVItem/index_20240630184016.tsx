...
export const CVItem = ({ name, style, dates, role, texts, tags }: any) => {
  return (
    <div
      ...
      style={style}
    >
      <div className="mb-0 flex w-full flex-col items-end justify-start border-b-4 border-pink-600 pb-2.5 sm:mb-0 sm:w-auto sm:border-b-0 sm:border-r-4 sm:pr-5">
